    ...
    <div className="container max-w-7xl mx-auto py-12">
      ...
      <motion.section className="mb-16" {...fadeInUp}>
        <p className="text-lg text-secondary max-w-3xl mx-auto text-center">
          ...
          web experiences. When I&apos;m not coding, you&apos;ll find me
          exploring new designs, learning new skills, or improving my projects.
        ...
        >
          ...
          >
            ...
            <ul className="text-secondary list-disc list-inside space-y-2">
              <li>
                Built multiple frontend projects using HTML,CSS,Javascript and
                Next.js.
              </li>
              <li>
                Developed responsive website like a portfolio, Weather App, and
                Rock Paper Scissors Game.
              </li>
              <li>Focused on writing clean,reusable,, and efficient code.</li>
              <li>
                Continuously learning new Framework and improving UI/UX design
                skills.
              </li>
            </ul>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-primary mb-2">
              University of Delhi • 2024 - Present
            </p>
            <p className="text-secondary">
              Currently pursing B.Com(Hons) with a focus on subjects like
